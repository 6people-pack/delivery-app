...
public class ReviewService {
    ...
    public ReviewResponseDto create(User user, ReviewCreateRequestDto req, List<MultipartFile> reviewImages) {
        //주문 요약 조회
        ...
        imageService.uploadImage(ImageCategory.review, saved.getId(), reviewImages);
    ...
    public void delete(User user, UUID reviewId) {
        ...
        r.delete(user.getId()); // 실제 user 정보 전달
        imageService.deleteImageFolder(ImageCategory.review, r.getId());
    }
}